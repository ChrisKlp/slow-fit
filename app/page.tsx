    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between bg-white px-16 py-32 sm:items-start dark:bg-black">
        ...
        <div className="flex flex-col gap-4 font-medium text-base sm:flex-row">
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-black/8 border-solid px-5 transition-colors hover:border-transparent hover:bg-black/8 md:w-[158px] dark:border-white/[.145] dark:hover:bg-[#1a1a1a]"
